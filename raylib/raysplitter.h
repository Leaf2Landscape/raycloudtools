...
bool RAYLIB_EXPORT splitGrid(const std::string &file_name, const std::string &cloud_name_stub,
                             const Eigen::Vector3d &cell_width, double overlap, const std::string& output_ext);
// --- END OF MODIFICATION ---
...
// --- START OF MODIFICATION ---
bool RAYLIB_EXPORT splitGrid(const std::string &file_name, const std::string &cloud_name_stub,
                             const Eigen::Vector4d &cell_width, double overlap, const std::string& output_ext);
// --- END OF MODIFICATION ---
...
// --- START OF MODIFICATION ---
bool RAYLIB_EXPORT splitColour(const std::string &file_name, const std::string &cloud_name_stub, bool seg_colour, const std::string& output_ext);
// --- END OF MODIFICATION ---
