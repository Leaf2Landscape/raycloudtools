...
namespace ray
{
  ...
  //   r_bar  = path_length_observed / num_rays_observed  (mean scan path through voxel)
  //   P_bar  = 1 - (num_hits / num_rays_observed)         (mean gap probability)
  ...
  // Guard: return 0.0 if G <= 0 or r_bar <= 0 or num_rays_observed < 1.
