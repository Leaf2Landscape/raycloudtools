                          ...
                          double G)
{
  ...
  const double r_bar = path_length / num_beams_weighted;  // mean scan path through voxel
  ...
  // arithmetic mean (path_length / num_beams_weighted) is available from the voxel
