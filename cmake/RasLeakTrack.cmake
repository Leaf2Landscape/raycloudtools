...
# ras_leak_track_target_enable(myprogram CONDITION MY_PROJECT_LEAK_TRACK)
# # For a CUDA based program, ensure you disable protect_shadow_gap checking:
# ras_leak_track_default_options(myprogram CONDITION MY_PROJECT_LEAK_TRACK "protect_shadow_gap=0")
#
#
# This enables all leak reporting for myprogram. Optionally, you can add additional ASAN options by passing additional
# arguments to ras_leak_track_default_options(). See Overview resource below.
#
...
# ras_leak_track_suppress(myprogram CONDITION MY_PROJECT_LEAK_TRACK
#     symbol1
#     symbol2
#     symbol3
# )
...
#
# ras_ras_leak_track_target_enable_asan(<target> [todo-options] [todo-suppress])
#
# This adds the required address santisiation parameters. This process also supports adding Address Sanitizer options
# and supressions.
function(ras_ras_leak_track_target_enable_asan TARGET)
...
endfunction(ras_ras_leak_track_target_enable_asan TARGET)
...
#
# ras_leak_track_suppress(<target> suppress1 [suppress2...])
#
...
function(ras_leak_track_suppress TARGET)
...
endfunction(ras_leak_track_suppress TARGET)

# Suppress a list of memory leaks for a target.
#
# ras_leak_track_suppress(<target> [CONDITION condition] suppress1 [suppress2...])
#
# To suppress memory leaks, the function is provided a list of symbols from which to ignore memory leaks. These symbols
# can be matched anywhere in the stack to be ignored.
function(ras_leak_track_default_options TARGET)
  if(NOT LEAK_TRACK_WITH_ASAN)
    return()
  endif(NOT LEAK_TRACK_WITH_ASAN)
...
endfunction(ras_leak_track_default_options TARGET)

# Enable memory leak checking for a target.
#
# ras_leak_track_target_enable(<target> [CONDITION condition])
#
...
function(ras_leak_track_target_enable TARGET)
  _leak_track_check_condition(CONDITION_OK _ARGN ${ARGN})
  if(NOT CONDITION_OK)
    return()
  endif(NOT CONDITION_OK)
  ...
  if(LEAK_TRACK_WITH_ASAN)
    ras_ras_leak_track_target_enable_asan(${TARGET})
  endif(LEAK_TRACK_WITH_ASAN)
endfunction(ras_leak_track_target_enable)