...
#
# Targets must be explicitly added for clang-tidy linting using the CMake function 'ras_clang_tidy_target(<target>)'. This
...
# Start searching down from clang-tidy version CT_SUFFIX ...
set(CT_VERSION 10)
# ... down to version CT_SUFFIX_LAST
set(CT_VERSION_LAST 5)
while(CT_VERSION GREATER_EQUAL CT_VERSION_LAST)
  list(APPEND CLANG_TIDY_NAMES "clang-tidy-${CT_VERSION}" "clang-tidy-${CT_VERSION}.0")
  math(EXPR CT_VERSION "${CT_VERSION} - 1")
endwhile(CT_VERSION GREATER_EQUAL CT_VERSION_LAST)
list(APPEND CLANG_TIDY_NAMES "clang-tidy")
...
if(NOT CLANG_TIDY_EXE)
  ...
  function(ras_clang_tidy_target)
  endfunction(ras_clang_tidy_target)
...
function(ras_clang_tidy_target TARGET)
